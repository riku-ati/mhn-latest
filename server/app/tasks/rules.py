...
from app.api.models import Rule, RuleSource
from app.common.ruleutils import from_buffer
...
def fetch_sources():
    ...
    for src in RuleSource.query:
        ...
        if resp.status_code == 200:
            ...
            app.logger.warning('Failed to download rules from "{}": HTTP {}'.format(
                src.uri, resp.status_code))
