...
from app.api.decorators import deploy_auth, sensor_auth, token_auth
...
# Now let's make use of these methods in the views.
...
def top_attackers():
    ...
    # Only keep hours_ago and limit in options dict
